...
X = df[["hadm_id_num", "gender","anchor_age","dod"]]
y = df[["subject_id"]]
print("")
print("dataset X:")
print(X)
...
plt.ylabel('CS')
plt.savefig(os.path.realpath('../0 Data/Clustring_Elbow_patient.png'))
plt.show()
...
plt.savefig(os.path.realpath('../0 Data/Clustring_Silhouette_patient.png'))
plt.show()
plt.show()
...
print("")
df_clustered = df[["subject_id","Cluster"]]
print(df_clustered)



symPath2='../gcKey/Patients_Clustered.csv'
Realpath2 = os.path.realpath(symPath2)
df2=df.to_csv(Realpath2,index=False)

symPath2='../gcKey/Patients_Clustered_Summary.csv'
Realpath2 = os.path.realpath(symPath2)
