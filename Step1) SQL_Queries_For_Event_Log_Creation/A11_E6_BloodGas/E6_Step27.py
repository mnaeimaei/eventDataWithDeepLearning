...
query1 = f'''            
        ...
        CREATE TABLE  `mimic-four-377221.E6_BloodGas.bgB14_D0K`   AS
        SELECT * FROM 
        (SELECT
        b.rowNum, b.Item1, b.Item2, b.Item4, b.Item6, b.Item8, b.Item9, b.Item14, b.Item16, b.Item17, b.Item18, b.Item19, b.Item20, b.Item21, b.Item23, b.Item24, b.Item26, b.Item29, b.Item32, b.Item33, b.Item34, b.Item35, b.Item36, b.Item37,
        ...
        LEFT JOIN `mimic-four-377221.E6_BloodGas.bgB14_C0`   as b
        ON
        a.HADM_ID=b.HADM_ID )
