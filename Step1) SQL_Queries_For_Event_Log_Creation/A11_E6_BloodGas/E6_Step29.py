...
query1 = f'''            
        ...
        CREATE TABLE  `mimic-four-377221.E6_BloodGas.bgB14_D2K`   AS
        SELECT * FROM 
        (SELECT
        b.rowNum, b.Item3, b.Item5, b.Item22, b.Item25, b.Item27,
        ...
        LEFT JOIN `mimic-four-377221.E6_BloodGas.bgB14_C2`   as b
        ON
        a.HADM_ID=b.HADM_ID )
