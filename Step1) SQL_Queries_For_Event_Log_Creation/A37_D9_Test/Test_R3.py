...
fr_classifier = RandomForestClassifier(random_state=42)
multi_classifier = MultiOutputClassifier(fr_classifier)
...
import joblib
joblib.dump(rf_best,'../File_TrainingData/'+algorithmDir+'/'+algType+FileName+'.joblib')
...
print("")
print("############# STEP 2 : Using RandomForest ############################################################################  ")
