...
query1 = f'''            
        ...
        CREATE TABLE  `mimic-four-377221.C0_EventLog.EL3`   AS
        SELECT
        ...
        b.RankN,
        From `mimic-four-377221.C0_EventLog.EL2`   as a
        LEFT JOIN `mimic-four-377221.C0_EventLog.Timing2`   as b
        ON
        a.subject_id=b.subject_id AND a.hadm_id=b.hadm_id 
        ;

drop table `mimic-four-377221.C0_EventLog.EL2` ;
drop table `mimic-four-377221.C0_EventLog.AEL2` ;       
drop table `mimic-four-377221.C0_EventLog.Timing2` ;
