...
#SBATCH --time=12-00:00:00    # Upper time limit for the job (DD-HH:MM:SS)
#SBATCH --nodes=1             # Allocate 1 nodes for the job
#SBATCH -c28
#SBATCH --mem=128G
#SBATCH --job-name="C11_Transfer"
#SBATCH --output=/cluster/home/miladna/PythonProject/DeepLearning/File_TrainingData/DeepMLP_CPU/C11_Transfer.txt
