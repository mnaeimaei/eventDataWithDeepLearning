...
#SBATCH -c28
#SBATCH --mem=64G
#SBATCH --job-name="C7_MicroB_PCA"
#SBATCH --output=/cluster/home/miladna/PythonProject/DeepLearning/File_TrainingData/DeepMLP_CPU/C7_MicroB_PCA.txt
