...
#SBATCH -c28
#SBATCH --mem=64G
#SBATCH --job-name="C10_Specimen"
#SBATCH --output=/cluster/home/miladna/PythonProject/DeepLearning/File_TrainingData/DeepMLP_CPU/C10_Specimen.txt
