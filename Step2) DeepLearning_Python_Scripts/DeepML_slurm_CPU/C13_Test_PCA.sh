...
#SBATCH -c28
#SBATCH --mem=64G
#SBATCH --job-name="C13_Test_PCA"
#SBATCH --output=/cluster/home/miladna/PythonProject/DeepLearning/File_TrainingData/DeepMLP_CPU/C13_Test_PCA.txt
